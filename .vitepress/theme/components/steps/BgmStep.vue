...
// Expose instance for melody step (uses shared singleton from useMidiGeneration)
...
function downloadMidi() {
  try {
    midiGen.downloadMidi(`midi-sketch-bgm-${Date.now()}.mid`)
  } catch {
...
<template>
  <div class="bgm-step">
    <!-- Header -->
    <StepHeader :title="t('bgmStep.title')" :subtitle="t('bgmStep.subtitle')" />
    ...
    <GenerationState
      ...
      :generating-text="t('bgmStep.button.generating')"
    />
    ...
    <div v-if="!isLoading && !isGenerating && !error && isGenerated" class="result-panel">
      ...
      <GenerationPreview
        ...
        :title="t('bgmStep.result.preview')"
        :regenerated-text="t('bgmStep.result.regenerated')"
      ...
      <div class="result-actions">
        ...
        <RegenerateCard
          ...
          :can-redo="canRedoBgm"
          :is-generating="isGenerating"
          :label="t('bgmStep.result.regenerate')"
        ...
        <!-- Download Button -->
        <DownloadButton
          :label="t('bgmStep.result.download')"
          color="purple"
