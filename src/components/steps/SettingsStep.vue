...
import CompositionPanel from '@/components/wizard/CompositionPanel.vue'
import InstrumentsPanel from '@/components/wizard/InstrumentsPanel.vue'
import HarmonyPanel from '@/components/wizard/HarmonyPanel.vue'
import OutputPanel from '@/components/wizard/OutputPanel.vue'
